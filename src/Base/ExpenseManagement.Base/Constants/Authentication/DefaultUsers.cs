namespace ExpenseManagement.Base.Constants.Authentication;

public class DefaultUsers
{
    public const string DefaultAdminPassword = "DefaultUsers:DefaultAdminPassword"; 
    ...
    public const string DefaultEmployeeUserName = "DefaultEmployee";
