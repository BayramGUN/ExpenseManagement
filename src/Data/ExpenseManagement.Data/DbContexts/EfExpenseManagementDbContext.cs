...
/// </summary>
public class EfExpenseManagementDbContext : DbContext
{   
    
    /// <summary>
    /// Initializes a new instance of the <see cref="EfExpenseManagementDbContext"/> class with the specified options.
    /// </summary>
    /// <param name="options">The options to be used by the DbContext.</param>
    public EfExpenseManagementDbContext(
        DbContextOptions<EfExpenseManagementDbContext> options) : base(options)
    {
    }
    ...
    {
        modelBuilder
            .ApplyConfigurationsFromAssembly(typeof(EfExpenseManagementDbContext).Assembly);
