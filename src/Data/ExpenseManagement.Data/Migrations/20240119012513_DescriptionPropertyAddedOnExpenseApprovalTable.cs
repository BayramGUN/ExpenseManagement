...
{
    /// <inheritdoc />
    public partial class DescriptionPropertyAddedOnExpenseApprovalTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptPhotoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InsertUserId = table.Column<int>(type: "int", nullable: false),
                    InsertDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateUserId = table.Column<int>(type: "int", nullable: true),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseApprovals_AppUsers_ApproverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_IdentityNumber",
                table: "AppUsers",
