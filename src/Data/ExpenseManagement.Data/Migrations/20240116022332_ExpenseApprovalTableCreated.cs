...
{
    /// <inheritdoc />
    public partial class ExpenseApprovalTableCreated : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseApproval_AppUsers_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseApproval_Expenses_ExpenseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseApproval_ApproverId",
